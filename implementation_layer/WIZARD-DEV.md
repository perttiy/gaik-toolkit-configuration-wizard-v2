...
| `npm run dev` ilman API:a (**UI-only**) | ei | In-memory mock (`ses_chatbot` jne.) | ❌ ei täytä tuotevaatimusta |
...
**Älä käytä demoon tai asiakaskatselmointiin.** UI-onlylla ei ole Postgres-persistenssiä;
